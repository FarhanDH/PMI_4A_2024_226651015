...
public class Listrik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("JENIS GOLONGAN");
        ...
        jLabel16.setText("JENIS GOLONGAN");

        lblDiscount.setText("Diskon");

        lblResultMember.setText("JENIS GOLONGAN");
    ...
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        String member = cmbGolongan.getSelectedItem().toString().toLowerCase();
